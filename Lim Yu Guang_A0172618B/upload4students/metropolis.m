...
current_encrypted_double = char2double(encrypted_txt);
current_decrypted_double = current_key(current_encrypted_double);
current_decrypted_txt = double2char(current_decrypted_double);

log_curr = logn_pr_txt(current_decrypted_txt, pr_trans);

new_encrypted_double = char2double(encrypted_txt);
new_decrypted_double = new_key(new_encrypted_double);
new_decrypted_txt = double2char(new_decrypted_double);

log_new = logn_pr_txt(new_decrypted_txt, pr_trans);
